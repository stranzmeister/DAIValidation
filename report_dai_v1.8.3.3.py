    ...
    try:
        ...
        try:
            ...
            if isinstance(ad_breaks, dict):
                ...
                values['stop_offset_with_delay'] = values['stop_offset'] + values['playback_delay']
                list_of_qvt_records.append(values.copy())
        ...
        with SQLiteDB() as cursor:
            cursor.executemany('''
                ...
                VALUES (
                    ...
                    :playback_delay, :start_offset_with_delay, 
                    :stop_offset_with_delay, :duration, :time_position, 
                    :title, :url, :content_type, :log
                );
            ''', values)
...
def save_html_report_to_disk(pod_id, slot_id, content):
    ...
    try:
        ...
        ##directory = r'C:\Users\shanil.jain.ECHOSTAR\Downloads'
